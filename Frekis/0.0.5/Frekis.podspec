...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/frekisSDK/ios-sdk-sample"
  ...
  spec.author             = { "Frekis Developers" => "info@frekis.com" }
  # Or just: spec.author    = "Frekis Developers"
  # spec.authors            = { "Frekis Developers" => "info@frekis.com" }
  # spec.social_media_url   = "https://twitter.com/Frekis Developers"
  ...
  spec.source       = { :git => "https://github.com/frekisSDK/ios-sdk-sample.git", :tag => "#{spec.version}" }
...
spec.ios.vendored_frameworks = "Frekis/FrekisFramework.framework"
  ...
  # spec.framework  = "FrekisFramework"
